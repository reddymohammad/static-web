...
#6 Convert Model Names to Uppercase  Use map() to convert every model name into uppercase. 

upper_models = list(map(lambda car: car['model'].upper(), cars))

print(upper_models)

# one line 

print(list(map(lambda car:car['model'].upper(), cars)))
